...
import { getDemoUser, listProposalsForUser } from "@/lib/repositories";
...
export default function ProposalsPage() {
  ...
  return (
    <main>
      ...
      <p className="mt-3 max-w-2xl text-slate-600">These sample records are queried from SQLite in a Server Component.</p>
